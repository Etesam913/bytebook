...
func TestGetConnectionInfoFromLanguage(t *testing.T) {
	...
	t.Run("Unsupported language", func(t *testing.T) {
		_, err := kernel_helpers.GetConnectionInfoFromLanguage(tempDir, "ruby")
		assert.Error(t, err)
	...
	t.Run("Python language", func(t *testing.T) {
		info, err := kernel_helpers.GetConnectionInfoFromLanguage(tempDir, "python")
	...
	t.Run("Golang language", func(t *testing.T) {
		info, err := kernel_helpers.GetConnectionInfoFromLanguage(tempDir, "golang")
		assert.NoError(t, err)
...
func TestGetAllConnectionInfo(t *testing.T) {
	...
	allInfo, err := kernel_helpers.GetAllConnectionInfo(tempDir)
	assert.NoError(t, err)
...
func TestIsVirtualEnv(t *testing.T) {
	t.Run("Identifies directory with pyvenv.cfg as virtual environment", func(t *testing.T) {
		...
		result := kernel_helpers.IsVirtualEnv(tempDir)
...
// TestGetPythonVirtualEnvironments tests the GetPythonVirtualEnvironments function.
...
func TestGetAllKernels(t *testing.T) {
	t.Run("Happy Path", func(t *testing.T) {
		...
		kernels, err := kernel_helpers.GetAllKernels(projectPath)
		assert.NoError(t, err)
	...
	t.Run("Existing Valid Files", func(t *testing.T) {
		...
		pythonKernel := project_types.KernelJson{
			Argv:        []string{"custom-python", "-f", "{connection_file}"},
			DisplayName: "Custom Python",
			Language:    "python",
		}

		golangKernel := project_types.KernelJson{
