...
export function AttachmentsAccordion({
	...
	return (
		<section className="border-[1px] w-[calc(100%-0.8rem)] border-zinc-200 dark:border-zinc-600 flex flex-col absolute bottom-0 max-h-[calc(100vh-14rem)] bg-[white] dark:bg-zinc-800 rounded-md">
			<button
