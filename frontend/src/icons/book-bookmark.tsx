    ...
    >
      <g fill={fill}>
        ...
        <path
          ...
          strokeWidth="1.5"
        />
        <circle cx="5.75" cy="9.75" fill={secondary} r=".75" stroke="none" />
        <circle cx="5.75" cy="4.75" fill={secondary} r=".75" stroke="none" />
        <circle cx="5.75" cy="7.25" fill={secondary} r=".75" stroke="none" />
      </g>
    </svg>
  );
}
