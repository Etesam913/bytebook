        ...
        >
          ...
          <Input
            ...
            inputProps={{
              ...
              className:
                'text-sm flex-1 dark:text-zinc-100 bg-transparent outline-none focus-visible:ring-2 focus-visible:ring-(--accent-color) rounded-sm border-none px-0.5 !border-0 font-code',
              autoFocus: true,
              autoCapitalize: 'off',
              autoComplete: 'off',
              autoCorrect: 'off',
